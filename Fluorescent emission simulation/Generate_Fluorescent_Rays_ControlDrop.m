...
% Droplet parameters & generation of contact angles:
    vr = 2; %volume ratio.  V_internal/v_external
    Rd = 1; %droplet radius
    dropAngle = 0;
    dropLocation = [0,0];
...
% How many droplets
    CA_start = 0;
    CA_end = 180;
    numPoints = 181; %In this current version, this is the amount of drops between 0 and 90, which gets doubled.
...
%    rayPerCore = 10000; %rays sent to each core [always less than total rays]
    ...
    rayPerCore = 10; %rays sent to each core [always less than total rays]
